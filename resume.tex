...
%The above user definitions are usedin the package below
\usepackage{resume}
\title{Resume}
\author{\UserName}
...
\> \UserPostalCode \\
% Dont want people knowing how old i am for age discriminatio lol  {\bf Date of Birth} \> 4$^{th}$ March 1979 \\
